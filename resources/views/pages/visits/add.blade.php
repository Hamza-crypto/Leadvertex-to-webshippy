...
@section('title', __('Add Doctor Visit'))
@section('scripts')

@endsection
@section('content')
    <h1 class="h3 mb-3">Add New Doctor Visit</h1>
                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="hospital" id="hospital"
                                class="form-control @error('hospital') is-invalid @enderror" value="{{ old('hospital') }}"
                                required>
                            @error('hospital')
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type"
                                ...
                                <option value="1" {{ old('type') == '1' ? 'selected' : '' }}>Government</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="potential" id="potential"
                                ...
                                <option value="1" {{ old('potential') == '1' ? 'selected' : '' }}>Low</option>
                                <option value="2" {{ old('potential') == '2' ? 'selected' : '' }}>Medium</option>
                                <option value="3" {{ old('potential') == '3' ? 'selected' : '' }}>High</option>
                            </select>
                            @error('potential')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="chain" id="chain"
                                class="form-control @error('chain') is-invalid @enderror" value="{{ old('chain') }}"
                                required>
                            @error('chain')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="visits" id="visits" rows="4" class="form-control @error('visits') is-invalid @enderror"
                                required>{{ old('visits') }}</textarea>
                            @error('visits')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Submit Button -->
                        <button type="submit" disabled class="btn btn-primary">Add Doctor Visit</button>
                    </form>
                </div>
            </div>
        </div>
